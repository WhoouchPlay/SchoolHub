...
class UserForm(UserCreationForm):
    ...
    first_name = forms.CharField(max_length=50, min_length=2, help_text="Введіть ім'я", label="Ім'я")
    last_name = forms.CharField(max_length=50,  min_length=2, help_text="Введіть прізвище",label="Прізвище")
    ...
    password2 = forms.CharField(help_text="Повторіть пароль", label="Підтвердження пароля", widget=forms.PasswordInput)
